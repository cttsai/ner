...
class problem(Structure):
	_names = ["l", "n", "y", "x", "bias", "coef0", "gamma"]
	_types = [c_int, c_int, POINTER(c_double), POINTER(POINTER(feature_node)), c_double, c_double, c_double]
	_fields_ = genFields(_names, _types)
...
class parameter(Structure):
	_names = ["solver_type", "eps", "C", "nr_weight", "weight_label", "weight", "p", "coef0", "gamma", "init_sol"]
	_types = [c_int, c_double, c_double, c_int, POINTER(c_int), POINTER(c_double), c_double, c_double, c_double, POINTER(c_double)]
	_fields_ = genFields(_names, _types)
